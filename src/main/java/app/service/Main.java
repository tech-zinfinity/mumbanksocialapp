...
public class Main {
    ...
    public static final String TOKEN = "1041747083:AAHlYuwfBOqry5ftNQPWjt9g93074LHTH5c";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            nameValuePairs.add(new BasicNameValuePair(CHATID_FIELD, chatId + "1011549445"));
            /// Add text to the list
            nameValuePairs.add(new BasicNameValuePair(TEXT_FIELD, "yyyyyyy123"));
